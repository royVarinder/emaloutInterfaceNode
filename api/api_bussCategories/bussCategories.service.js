...
module.exports = {
    ...
    //     pool.query(`insert into emalout_bussinesses (user_name, user_contact, buss_name,buss_contact, category_id, buss_address, buss_city, buss_district, features, weekdays, buss_images)
    //     values(?,?,?,?,?,?,?,?,?,?,?)`,
    //      [
    //         data.yourName,
    //         data.yourContact,
